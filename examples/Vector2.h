...
class Vector {
  ...
  public:
    ...
    Vector(Vector & obj) {
        begin =
            new VectorType[0]; // Points to the beginning of the new array, it's zero but this line keeps malloc from seg faulting should we delete begin before resizing it
        head    = -1;
